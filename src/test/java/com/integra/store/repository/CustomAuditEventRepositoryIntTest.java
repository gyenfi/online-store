package com.integra.store.repository;

import com.integra.store.StoreApp;
import com.integra.store.config.Constants;
import com.integra.store.config.audit.AuditEventConverter;
import com.integra.store.domain.PersistentAuditEvent;
...
import static com.integra.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
